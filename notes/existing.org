...
** Checkpoints
   ...
   #+BEGIN_SRC python :results file :session main :exports both :python ipython
     ...
     Gt.add_node("all-beginner", color="lightblue", shape="oval")
     Gt.add_node("cp-beginner", color="lightblue", shape="oval")
     ...
     G.add_node("all-beginner", color="lightblue", shape="oval")
     G.add_node("cp-beginner", color="lightblue", shape="oval")
